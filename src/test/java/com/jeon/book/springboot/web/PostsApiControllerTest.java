...
/*
api 테스트에서는 @WebMvmTest 를 사용하지 않음
@WebMvmTest 의 경우 JPA 기능이 작동하지 않는 이유
Controller 와 ControllerAdvice 등 외부 연동과 관련된 부분만 활성화
따라서 JPA 기능까지 한번에 테스트 할 시 에는 @SpringBootTest 와 TestRestTemplate 를 함께 사용하면 된다.
